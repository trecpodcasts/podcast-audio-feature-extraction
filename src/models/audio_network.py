...
class BaseContrastiveModel(tf.keras.Model):
...
def get_contrastive_network(
    ...
    return BaseContrastiveModel(
        embedding_model, temperature, similarity_layer, similarity_type
    )
