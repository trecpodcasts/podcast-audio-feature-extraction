...
class SupervisedModule:
    ...
    def __init__(self, strategy, cfg):
        ...
        self._ds_dataset = cfg.ds_dataset
    ...
    def _prepare_downstream_task_data(self):
        ...
        train_data, test_data, self._num_classes = data.get_audio_dataset(
            self._ds_dataset, self._shuffle_buffer
        )
    ...
    def train_eval(
        ...
        contrastive_similarity_type="bilinear",
        ...
        if load_pretrained:
            ...
            ssl_model_dir = "{0}/{1}".format(self._ssl_dataset, ssl_model_ckpt_id)
            ckpt_path = os.path.join(self._model_path, ssl_model_dir)

            ssl_network = models.get_contrastive_network(
        ...
        ds_model_dir = f"{self._ds_dataset}/{self._experiment_id}/"
